...
### Stealth attacks
Attacking from stealth or an undetected position: +2 ATK and maximum weapon damage + STR modifier (applied once). All damage bypasses mundane armor. Stealth is lost after the attack.

Talents (Thief, Assassin, Sniper) add **+1d6** to stealth attack damage, all bypassing AR. This bonus can be upgraded to **+2d6** through training or accomplishment.
...
Conditions may impose situational penalties at referee discretion. A broken arm imposes −1 on attack rolls; a hex −1 on saves.
